...
<body class="bg-gray-50">
    <!-- Navbar -->
    <nav class="fixed top-0 left-0 right-0 z-30 bg-primary-red shadow-sm h-16">
        ...
        <div class="p-4">
            ...
            <div class="flex items-center mb-6 p-3 bg-white bg-opacity-10 rounded-lg">
                <div class="relative mr-3">
                    ...
                    @endif
                    <span class="absolute bottom-0 right-0 block h-3 w-3 rounded-full bg-green-400 ring-2 ring-primary-red"></span>
                </div>
                <div>
            ...
            <ul class="space-y-2">
                ...
                <li>
                    <a href="{{ route('admin.employees.import') }}" class="flex items-center px-3 py-3 text-sm rounded-md nav-link {{ request()->routeIs('admin.employees.import') ? 'active' : '' }}">
                        <i class="fas fa-upload mr-3"></i> Upload Employees
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.employees.qr-codes') }}" class="flex items-center px-3 py-3 text-sm rounded-md nav-link {{ request()->routeIs('admin.employees.qr-codes') ? 'active' : '' }}">
                        <i class="fas fa-qrcode mr-3"></i> QR Codes
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('admin.verifications') }}" class="flex items-center px-3 py-3 text-sm rounded-md nav-link {{ request()->routeIs('admin.verifications') ? 'active' : '' }}">
                        <i class="fas fa-user-check mr-3"></i> Pending Verifications
                ...
                <li>
                    <a href="{{ route('admin.analytics') }}" class="flex items-center px-3 py-3 text-sm rounded-md nav-link {{ request()->routeIs('admin.analytics') ? 'active' : '' }}">
                ...
                <li>
                    <a href="{{ route('profile.show') }}" class="flex items-center px-3 py-3 text-sm rounded-md nav-link {{ request()->routeIs('profile.show') ? 'active' : '' }}">
